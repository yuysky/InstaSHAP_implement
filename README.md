...
InstaSHAP relies on [SIAN (Sparse Interaction Additive Networks)](https://github.com/matteo-enovouen/sparse-interaction-additive-networks) for interaction detection. The official package has incorrect imports in some files, so we ship a patched version.
